...
const LottieSplash = (props) => {
  ...
  return (
   <Fade big>
    <div className="splash-container main-page" style={{ backgroundColor: theme.dark }}>
      <div className="splash-animation-container">
        <DisplayLottie animationData={animData} />
      </div>
      <div className="splash-title-container">
        <span className="grey-color" style={{ color: theme.secondaryText }}> &lt;</span>
        <span className="splash-title" style={{ color: theme.highlight }}>{greeting.title}</span>
        <span className="grey-color" style={{ color: theme.secondaryText }}>/&gt;</span>
      </div>
    </div>
   </Fade>
