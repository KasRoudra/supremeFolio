...
const ContactMessage = (props) => {
    ...
    const handleSubmit = async (e) => {
        ...
        document.getElementById("buttonsub").innerHTML = `<button type="submit" class="btn btn-primary" style="color:white;padding: 7px" disabled>
                              Send Message
                            </button>`;    
        ...
        document.getElementById("buttonsub").innerHTML = `<button type="submit" class="btn btn-primary" style="color:white;padding: 7px">
                              Send Message
                            </button>`;
    }
            ...
            <Container>
                <Row>
                    ...
                    <Col md={12} className="px-5 pt-4">
                        <Form onSubmit={handleSubmit} className="form-inline justify-content-center" id="cont-form">
                            <Row className="mb-3">
                            ...
                            <div id="buttonsub">
                            <button type="submit" className="btn btn-primary"style={{ color: "white", padding:"7px"}}>
                              Send Message
                            </button>
                            </div>
                        </Form>
